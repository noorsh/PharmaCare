...
namespace PharmaCare.Data.Migrations
{
    ...
    [Migration("20260509155941_AddConsultationAttachments2")]
    partial class AddConsultationAttachments2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PharmaCare.Data.Models.ConsultationAttachment", b =>
                {
            ...
            modelBuilder.Entity("PharmaCare.Data.Models.ConsultationAttachment", b =>
                {
                    ...
                    b.HasOne("PharmaCare.Data.Models.ApplicationUser", "RequestedBy")
                        .WithMany()
                        .HasForeignKey("RequestedByUserId");

                    b.HasOne("PharmaCare.Data.Models.ApplicationUser", "UploadedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Recommendation", b =>
                {
                    b.HasOne("PharmaCare.Data.Models.Consultation", "Consultation")
                        ...
                        .HasForeignKey("Recommendation", "ConsultationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
